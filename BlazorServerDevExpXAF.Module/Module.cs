...
namespace BlazorServerDevExpXAF.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class BlazorServerDevExpXAFModule : ModuleBase {
    public BlazorServerDevExpXAFModule() {
		// 
		// BlazorServerDevExpXAFModule
		// 
